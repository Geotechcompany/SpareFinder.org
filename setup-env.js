...
/**
 * GeoTech PartFinder AI - Environment Setup Script
 * 
...
console.log('🚀 GeoTech PartFinder AI - Environment Setup');
console.log('============================================');
console.log('This script will help you configure the environment for the AI service.\n');

// Frontend .env.local content
const frontendEnvContent = `# GeoTech PartFinder AI - Frontend Environment
...
VITE_APP_NAME="GeoTech PartFinder AI"
...
# Generated by setup script for GeoTech PartFinder AI
...
async function setupEnvironment() {
    try {
        ...
        if (fs.existsSync(frontendEnvPath)) {
            const overwrite = await askQuestion('❓ Frontend .env.local already exists. Overwrite? (y/N): ');
            if (overwrite.toLowerCase() !== 'y') {
                console.log('⏭️  Skipping frontend environment setup...');
            } else {
        ...
        if (fs.existsSync(aiServiceEnvPath)) {
            const overwrite = await askQuestion('❓ AI service .env already exists. Overwrite? (y/N): ');
            if (overwrite.toLowerCase() !== 'y') {
                console.log('⏭️  Skipping AI service environment setup...');
            } else {
                fs.writeFileSync(aiServiceEnvPath, aiServiceEnvContent);
                console.log('✅ Created AI service .env');
            }
        } else {
            fs.writeFileSync(aiServiceEnvPath, aiServiceEnvContent);
            console.log('✅ Created AI service .env');
        ...
        console.log('   • Set up Supabase account and update SUPABASE_* variables');
        console.log('   • Get Google Custom Search API key for enhanced results');
        console.log('   • Get Octopart API key for part database access');
        console.log('\n📚 Documentation:');
        console.log('   • Check README.md for detailed setup instructions');
        console.log('   • Environment template: env.template');
        console.log('   • AI service docs: ai-service/README.md');
