#!/usr/bin/env python3
"""
Simple migration script that migrates jobs one by one
Handles PostgreSQL array syntax correctly
"""
...
def migrate_all_jobs():
    """Migrate all jobs with simplified approach"""
    
    print("Simple Job Migration to Supabase")
    print("=" * 40)
    ...
    for i, json_file in enumerate(json_files, 1):
        try:
            ...
            # Save SQL to file
            sql_file = f"simple_migrate_job_{i:02d}_{job_id}.sql"
...
if __name__ == "__main__":
    print("Preparing simple job migration...")
    
    if migrate_all_jobs():
        print("\nSUCCESS: Simple job migration preparation successful!")
        print("All SQL files have been generated with simplified data.")
        print("Ready to execute the migration!")
    else:
        print("\nERROR: Simple job migration preparation failed")
        exit(1)
