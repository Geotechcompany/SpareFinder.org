...
const ApiDocsContent: React.FC<{ apiBaseUrl: string }> = ({ apiBaseUrl }) => (
      ...
      <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        {hasApiAccess ? (
          ...
          <FeatureLock
            ...
            description="API documentation is available to signed-in Professional and Enterprise subscribers."
            showContent={false}
          />
        )}
      </div>
