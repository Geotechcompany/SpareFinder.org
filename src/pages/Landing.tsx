        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center">
            <motion.div
              ...
              className="mb-8"
            >
              <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-500/20 to-blue-500/20 rounded-full border border-purple-500/30 backdrop-blur-xl mb-8">
                <motion.div
                  animate={{ rotate: 360 }}
                ...
                <span className="flex items-center gap-3">
                  ...
                  <div className="relative">
                    ...
                    <motion.div
                      ...
                      className="absolute inset-0 w-3 h-3 bg-purple-400/30 rounded-full"
                    />
                  </div>
                </span>
              </Button>
              ...
              <div className="relative rounded-3xl overflow-hidden border border-white/10 backdrop-blur-xl">
                ...
                <div className="absolute inset-0">
                  <motion.div
                    ...
                    className="absolute top-1/4 left-1/4 w-12 h-12 -translate-x-1/2 -translate-y-1/2"
                  >
                    <div className="relative">
                  ...
                  <motion.div
                    ...
                    className="absolute top-1/2 right-1/3 w-12 h-12 -translate-x-1/2 -translate-y-1/2"
                  >
                    <div className="relative">
