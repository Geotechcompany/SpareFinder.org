 ...
 * Tests the production WebSocket URL: wss://aiagent-sparefinder-org.onrender.com/ws/progress
 * 
 * Usage:
...
const WS_URL = process.env.WS_URL || 'wss://aiagent-sparefinder-org.onrender.com/ws/progress';
...
ws.on('error', (error) => {
    ...
    console.error('  1. Check if the URL is correct: wss://aiagent-sparefinder-org.onrender.com/ws/progress');
